...
(function (angular) {
    ...
    angular.module('webapp.controllers').controller('dashboardCtrl', ['$scope', 'dataService', function ($scope, dataService) {
        ...
        $scope.colors = [{ name: 'red' }, { name: 'blue' }, { name: 'green' }, { name: 'yellow' }, { name: 'purple' }, { name: 'gray' }, { name: 'gray' }, { name: 'gray' }, { name: 'gray' }, { name: 'gray' }, { name: 'gray' }, { name: 'gray' }, { name: 'gray' }, { name: 'gray' }, { name: 'gray' }];
    ...
    angular.module('webapp.services').service('dataService', ['$q', '$http', function ($q, $http) {
        ...
        let service = () => {
            return {
                get: () => {
                    var q = $q.defer();
                    $http.get('https://api.myjson.com/bins/ydbh').success(data => {
                        q.resolve(data);
                        // q.reject('GIFT FAIL')
                    });
